...
function loginajax(){
	...
	if (window.XMLHttpRequest) {
		  ...
		  xhttp.open("GET", "http://172.20.20.197/projectwork/login/login.php?username="+usern+"&passwd="+pass, true);		  
		  xhttp.send();
		}
function sendSms(){
...
function registerajax(){
	...
	if (window.XMLHttpRequest) {
		  ...
		  //Direct it to the page that you want the results to be displayed on
		  xhttp.open("GET", "http://172.20.20.197/projectwork/register.php?username="+usern+"&passwd="+pass+"&age="+age+"&pnumber="+pnumber+"&email="+mail, true);		  
		  xhttp.send();
		}
